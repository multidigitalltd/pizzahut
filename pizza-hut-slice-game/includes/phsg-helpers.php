		...
		$sections = array(
			...
			array(
				...
				'items' => array(
					...
					__( 'מובהר בזאת כי הפעילות המתוארת בתקנון זה אינה מיועדת ואינה חלה על עובדי טאבסקו החזקות בע"מ ו/או עובדי הזכיינים המפעילים סניפי פיצה האט בישראל, וכן על בני משפחותיהם מדרגה ראשונה (הורים, בני/בנות זוג וילדים). החברה שומרת לעצמה את הזכות לפסול השתתפות של מי מהאמורים לעיל בפעילות, לרבות ביטול זכייה/הטבה שניתנה בניגוד לאמור.', 'pizza-hut-slice-game' ),
				),
			),
		);
